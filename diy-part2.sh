...
# 修改openwrt登陆地址,把下面的10.0.0.253修改成你想要的就可以了
...
sed -i "s/OpenWrt /ababwbq build $(TZ=UTC-8 date "+%Y.%m.%d") @ https:\/\/github.com\/KigoZou\/Actions-OpenWrt-Xiaomi-R4A @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
